...
hidden if the `Trident_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Trident_DEVELOPER_MODE` to the configure
...
Runs the executable target `Trident_exe`.
